...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_WEB}/api/revisar-datos/${params.negocioId}?establecimiento_id=${establecimientoId}&datos_clave_negocio_id=${datosClaveNegocioId}&datos_bancarios_id=${datosBancariosId}`)
