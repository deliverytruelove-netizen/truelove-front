        ...
        <div className="flex min-h-screen">
            <div className="hidden lg:flex lg:w-1/2 bg-red-50 items-center justify-center">
                <div className="max-w-md p-8">
                    ...
                    <h4 className="text-2xl font-bold mb-6 text-center text-red-800">Transforma tu negocio con True Love Portal</h4>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
                <div className="max-w-md w-full">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <h3 className="text-2xl font-bold text-center mb-6 text-red-800">Inicia sesión con tu usuario</h3>
                        <div>
                            <label htmlFor="usuario" className="block text-sm font-medium text-red-700 mb-1">Usuario</label>
                            <input
                                type="text"
                                name="usuario"
                                id="usuario"
                        ...
                        <div className="relative">
                            <label htmlFor="password" className="block text-sm font-medium text-red-700 mb-1">Contraseña</label>
                            <input
