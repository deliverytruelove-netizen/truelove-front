// app\login\recuperar-contrasena\page.tsx
'use client'
      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-red-50 items-center justify-center">
          <div className="max-w-md p-8">
            <div className="mb-8">
              <Image src="/food.svg" alt="Store Icon" width={800} height={435} className="w-full h-auto" />
            </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
          <div className="max-w-md w-full">
            <form onSubmit={handleSubmit} className="space-y-6">
              <h3 className="text-2xl font-bold text-center mb-6 text-red-800">Restablece tu contraseña</h3>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  disabled={isCodeSent || isLoading || !formData.email}
              ...
              {isCodeSent && !isCodeVerified && (
                <div className="flex items-center space-x-2">
                  <div className="flex-grow">
                    <label htmlFor="verificationCode" className="block text-sm font-medium text-red-700 mb-1">
                  ...
                  <button
                    ...
                    className="mt-6 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition duration-200 disabled:opacity-50"
                  >
                    {isLoading ? <Loader2 className="animate-spin h-5 w-5" /> : "Validar"}
                  </button>
                </div>
              )}
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 text-red-900 placeholder-red-300 ${
                  ...
                  {formData.confirmPassword && (
                    <div className={`flex items-center mt-1 text-sm ${passwordMatch ? 'text-green-600' : 'text-red-600'}`}>
                      {passwordMatch ? <FaCheck className="mr-1" /> : <FaTimes className="mr-1" />}
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1">
                    {Object.entries(passwordValidation).map(([key, isValid]) => (
                      <li
                        key={key}
                        className={`flex items-center text-sm ${isValid ? "text-green-600" : "text-red-600"}`}
                      >
              ...
              {errorMessage && <p className="text-sm text-red-600 bg-red-50 p-3 rounded-md">{errorMessage}</p>}
              ...
              <div className="flex gap-4">
                ...
                {isCodeVerified && (
                  <button
                    type="submit"
                    disabled={isLoading || !Object.values(passwordValidation).every(Boolean) || !passwordMatch}
                  ...
                  >
                    {isLoading ? <Loader2 className="animate-spin h-5 w-5 mx-auto" /> : "Restablecer contraseña"}
                  </button>
                )}
              </div>
            </form>
