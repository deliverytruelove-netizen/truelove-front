...
function SocioAdminLayoutContent({
  children,
}: {
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-800">
          {!isCollapsed && (
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Panel Socio</h2>
            </div>
          )}
          <Button
            variant="ghost"
            ...
            <div className="rounded-lg bg-gray-50 dark:bg-gray-800 p-3 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center space-x-3">
                ...
                <div className="space-y-0.5">
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Modo Socio</p>
