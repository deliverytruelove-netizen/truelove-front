      ...
      <div className="p-4">
        {grupos.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-3">
            {grupos.map((grupo) => (
              <div key={grupo.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow bg-gray-50">
                {/* Header del grupo */}
                <div className="mb-3">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-1">
                    <h3 className="font-semibold text-base text-gray-900 break-words">{grupo.nombre}</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-3 border-t border-gray-200">
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none bg-red-100 text-red-700 px-2 py-1.5 rounded-lg hover:bg-red-200 transition-colors flex items-center justify-center gap-1.5 text-sm font-medium"
                  >
