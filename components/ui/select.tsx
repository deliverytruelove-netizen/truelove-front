...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 text-sm transition-colors placeholder:text-gray-500 focus:border-[#f34739] focus-visible:outline-none focus-visible:border-[#f34739] disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 data-[state=open]:border-[#f34739]",
      className,
    )}
    {...props}
  >
