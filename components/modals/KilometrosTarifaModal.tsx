...
const KilometrosTarifaModal: React.FC<KilometrosTarifaModalProps> = ({
  ...
  useEffect(() => {
    if (editingTarifa) {
      setFormData({
        ...
        precio_maximo: (editingTarifa.precio_maximo ?? "0").toString(),
        distancia_minima: (editingTarifa.distancia_minima ?? "0").toString(),
        distancia_maxima: (editingTarifa.distancia_maxima ?? "0").toString(),
  ...
  const validateForm = (): boolean => {
    ...
    if (Number(formData.precio_base_diurno) > Number(formData.precio_maximo)) {
      newErrors.precio_base_diurno = "El precio base diurno no puede ser mayor que el precio máximo"
    }

    if (Number(formData.precio_base_nocturno) > Number(formData.precio_maximo)) {
      newErrors.precio_base_nocturno = "El precio base nocturno no puede ser mayor que el precio máximo"
    }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submitData = {
      ...
      distancia_minima: Number(formData.distancia_minima),
      distancia_maxima: Number(formData.distancia_maxima),
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Input
                  ...
                  disabled={isLoading}
                />
                <p className="text-xs text-gray-500 mt-1">05:00 - 22:59</p>
              ...
              <div>
                ...
                <Input
                  ...
                  disabled={isLoading}
                />
                <p className="text-xs text-gray-500 mt-1">23:00 - 04:59</p>
              ...
              <div>
                <Label htmlFor="precio_maximo">Precio Máximo (S/) *</Label>
                <Input
                  id="precio_maximo"
                  name="precio_maximo"
                  type="number"
                  ...
                  disabled={isLoading}
                />
                <p className="text-xs text-gray-500 mt-1">Precio tope</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  disabled={isLoading}
                />
                <p className="text-xs text-gray-500 mt-1">Distancia mínima para aplicar precio base</p>
              ...
              <div>
                ...
                <Input
                  ...
                  disabled={isLoading}
                />
                <p className="text-xs text-gray-500 mt-1">Distancia para aplicar precio máximo</p>
